...
| ID | 状态 | 交付结果 | 依赖 | 最窄验证 |
|---|---|---|---|---|
| W1-01 | `TODO` | 领域身份与值对象 | Wave 0 | JVM 单元测试 |
| W1-02 | `TODO` | 曲目、隐藏与路径规则 Room 契约 | W1-01 | Room 设备测试 |
| W1-03 | `TODO` | 播放列表、历史与快照 Room 契约 | W1-01 | Room 设备测试 |
| W1-04 | `TODO` | Preferences DataStore 设置 | W1-01 | DataStore 测试 |
| W1-05 | `TODO` | Repository 接口与 Fake | W1-02～W1-04 | 契约测试 |
| W1-06 | `TODO` | 播放列表与历史纯规则 | W1-01、W1-03 | JVM 单元测试 |
| W1-07 | `TODO` | 队列、模式与快照数据契约 | W1-01、W1-03 | 往返/不变量测试 |
| W1-08 | `TODO` | v1 Schema 与 Release 门禁 | W1-02～W1-07 | Schema/Release 检查 |
