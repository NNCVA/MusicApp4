...
- 当前仍维护的设计资料仅包括通用组件规范 [`docs/design/selection-and-toggle-controls.md`](docs/design/selection-and-toggle-controls.md)、资源/许可证规范 [`docs/design/resource-governance.md`](docs/design/resource-governance.md)，以及业务规则规范（[`docs/design/artist-splitting-rules.md`](docs/design/artist-splitting-rules.md)、[`docs/design/album-grouping-rules.md`](docs/design/album-grouping-rules.md)、[`docs/design/audio-format-registry.md`](docs/design/audio-format-registry.md)）；页面级 PRD 和首版规格统一在 `docs/design/archive/` 追溯。
